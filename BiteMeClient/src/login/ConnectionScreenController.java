...
/**
 * Controller class for the connection screen of the application.
 * Manages user interactions with the connection screen and initiates a connection to the server.
 * @author yosra
 */
public class ConnectionScreenController {
    ...
    /**
     * Initializes the connection screen controller.
     * Disables the connect button initially and adds listeners to enable/disable it based on input validation.
     */
    ...
    /**
     * Validates the input fields and enables/disables the connect button accordingly.
     */
    ...
    /**
     * Starts the JavaFX application by setting up the primary stage with the connection screen.
