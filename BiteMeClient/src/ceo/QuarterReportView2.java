	  ...
	  @FXML
		...
		private void initialize() {
			...
			if(restaurantName2 == null) {
		        ...
		        Message msg2 = new Message(new Object[]{restaurantId1, quarter1}, Commands. RestaurantQuarterIncomeReport1);
		        ...
		        Message msg3 = new Message(new Object[]{restaurantId1, quarter2}, Commands. RestaurantQuarterIncomeReport2);
		        ...
		        Message msg3 = new Message(new Object[]{restaurantId2, quarter1}, Commands. RestaurantQuarterIncomeReport2);
		        ClientController.client.handleMessageFromClientControllers(msg3); 
